...
import com.ehinfo.hr.common.utils.echarts.GsonOption;
import com.ehinfo.hr.common.utils.echarts.Option;
import com.ehinfo.hr.common.utils.echarts.Title;
import com.ehinfo.hr.common.utils.echarts.Toolbox;
import com.ehinfo.hr.common.utils.echarts.axis.AxisLabel;
...
import com.ehinfo.hr.common.utils.echarts.code.Magic;
import com.ehinfo.hr.common.utils.echarts.code.MarkType;
import com.ehinfo.hr.common.utils.echarts.code.SelectedMode;
import com.ehinfo.hr.common.utils.echarts.code.Tool;
import com.ehinfo.hr.common.utils.echarts.code.Trigger;
import com.ehinfo.hr.common.utils.echarts.code.X;
import com.ehinfo.hr.common.utils.echarts.code.Y;
import com.ehinfo.hr.common.utils.echarts.data.Data;
import com.ehinfo.hr.common.utils.echarts.data.LineData;
import com.ehinfo.hr.common.utils.echarts.data.PieData;
import com.ehinfo.hr.common.utils.echarts.data.PointData;
import com.ehinfo.hr.common.utils.echarts.feature.DataView;
import com.ehinfo.hr.common.utils.echarts.feature.MagicType;
import com.ehinfo.hr.common.utils.echarts.feature.Mark;
import com.ehinfo.hr.common.utils.echarts.feature.Restore;
import com.ehinfo.hr.common.utils.echarts.feature.SaveAsImage;
import com.ehinfo.hr.common.utils.echarts.series.Bar;
import com.ehinfo.hr.common.utils.echarts.series.Funnel;
import com.ehinfo.hr.common.utils.echarts.series.K;
import com.ehinfo.hr.common.utils.echarts.series.Line;
import com.ehinfo.hr.common.utils.echarts.series.MapLocation;
import com.ehinfo.hr.common.utils.echarts.series.MarkLine;
import com.ehinfo.hr.common.utils.echarts.series.MarkPoint;
import com.ehinfo.hr.common.utils.echarts.series.Pie;
...
public class EChartsController extends BaseController<Object>{
	...
	private String map(){
		GsonOption option =new GsonOption();
		com.ehinfo.hr.common.utils.echarts.series.Map map = new com.ehinfo.hr.common.utils.echarts.series.Map("Map");
