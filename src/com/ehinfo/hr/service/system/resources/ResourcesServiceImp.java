package com.ehinfo.hr.service.system.resources;
...
import com.ehinfo.hr.repository.system.resources.ResourcesDao;
...
public class ResourcesServiceImp extends BaseServiceImp<Resources> implements ResourcesService {
	...
	@Override
	public List<Resources> findMenuTree(String userId,String layer,String path) {			
		return ((ResourcesDao) baseDao).findMenuTree(userId,layer,path);
	}
	@Override
	...
	@Override
	public List<ZNodes> getSalaryTypeTree() {
		return ((ResourcesDao) baseDao).getSalaryTypeTree();
	}
