package com.ehinfo.hr.repository.system.resources;
...
public interface ResourcesDao extends BaseDao<Resources>{
     ...
     * @return
     */
	public List<Resources> findMenuTree(@Param("userId")String userId,@Param("layer")String layer,@Param("basePath")String path);
	 /**
     * 按钮列
     * @param menuId
     * @param userId
