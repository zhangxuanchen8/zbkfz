...
function getcaijiForm(id){
	$("#caiijpz").attr("href","backstage/shujuljdy/caijibj?id="+id);
	$("#caiijpz").click();
}
</script>
<div class="pageHeader">
    <form id="pagerForm" onsubmit="return navTabSearch(this);" action="<%=basePath%>/backstage/shujuljdy/cjpzindex"  method="POST">
            ...
            <ul class="searchContent">
                ...
                <li><a class="btn btn-orange btn-sm" href="javascript:navTab.reload('', {clearQuery:true});">清空查询</a></li>
                 <li class="pull-right">
                 	...
                 	<a href="backstage/shujuljdy/delCaiJipz" class="btn btn-default btn-sm" title="确定要删除吗,删除将无法还原?" target="checkedAjaxTodo" idname="ids">删除</a>
                </li>
            </ul>
        </div>
    </form>
