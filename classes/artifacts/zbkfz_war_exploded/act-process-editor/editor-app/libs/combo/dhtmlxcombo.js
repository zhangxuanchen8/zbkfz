...
dhtmlXCombo.prototype._positList = function() {
    ...
    var scrollTop=checkBrowser()=="Mozilla"?document.body.scrollTop:document.documentElement.scrollTop;
    var height=this.DOMlist.style.height!=""?parseInt(this.DOMlist.style.height):parseInt($(".dhx_combo_list").css("height"));
    if(document.documentElement.clientHeight-(pos[1]-scrollTop)<(24+height)){
    	this.DOMlist.style.top = pos[1]-this.DOMlist.offsetHeight-height+"px";
...
dhtmlXCombo_defaultOption.prototype._DrawHeaderButton = function(self, name, width) {
    ...
    //self.DOMelem.appendChild(z);	/*GL*/
    //self.DOMelem_button = z	/*GL*/
};
