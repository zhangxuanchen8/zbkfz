...
var navTab = {
    ...
    init: function(options) {
        ...
        this.componentBox = $("#"+this._op.id);    // $("#navTab") 里面的clss=".navTab-tab"的元素
    ...
    openTab: function(tabid, url, options) { //if found tabid replace tab, else create a new tab.
        ...
        if (iOpenIndex >= 0) {
            ...
            //这个就是加标签页的标签，然后替换tabId和显示的标题
            
            this._tabBox.append(tabFrag.replaceAll("#tabid#", tabid).replaceAll("#title#", op.title));//---------加切换页面的tab
            this._panelBox.append('<div class="page unitBox"></div>');
            this._moreBox.append('<li><a href="javascript:" title="#title#">#title#</a></li>'.replaceAll("#title#", op.title));//---下拉箭头的切换tab的代码
            ...
            this._contextmenu($tabs.filter(":last"));
        }
