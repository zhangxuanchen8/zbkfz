...
<div class=" panel panel-default"  style="padding:0px;overflow: auto;width:16%;float: left;display:none" layoutH="0" >
...
<div  <%--class="col-md-10 "--%> style="padding:0px; " id="modelAddForm">
	<input type="hidden" id="baseUserName_id" value="${baseUserName}"/>
	<jsp:include page="modelTable.jsp" flush="true"/>
</div>
